...
<div x-data="{ 
    ...
    <div class="flex flex-col gap-4 mb-8">
        ...
        {{-- Tombol Tambah: Sekarang konsisten dengan desain Data Pembina --}}
    ...
    {{-- Filter Pencarian: Sama dengan Data Pembina --}}
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {{-- Logic Filter: x-show mengecek variabel search --}}
    ...
    {{-- Modal Tambah: Disesuaikan agar seragam --}}
    <div x-show="openAdd" 

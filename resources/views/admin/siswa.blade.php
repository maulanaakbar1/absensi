...
<div x-data="{
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    @php
                        ...
                        if ($s->tahun_masuk && $s->tingkat_awal) {
                            ...
                            $tingkat = ($tahunSekarang - $s->tahun_masuk)
                                + $s->tingkat_awal;
                        }
    ...
    @if($anggota->hasPages())
        <div class="mt-6 bg-white px-6 py-5 rounded-[2rem] border border-slate-200 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
    ...
    <div x-show="openModal" class="fixed inset-0 z-[99] overflow-y-auto" x-cloak>
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block overflow-hidden text-left align-bottom transition-all transform bg-white rounded-[2.5rem] shadow-2xl sm:my-8 sm:align-middle sm:max-w-xl sm:w-full p-8">

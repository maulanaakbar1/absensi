...
<div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 overflow-hidden">
    ...
    <div class="flex justify-center gap-2">
        ...
        <button onclick="editOrg({{ $org }})" title="Edit"
        ...
        <form action="{{ route('organisasi.destroy', $org->id) }}" 
            method="POST" 
            onsubmit="return confirm('Apakah Anda yakin ingin menghapus organisasi {{ $org->nama_organisasi }}?')">
            @csrf
            @method('DELETE')
